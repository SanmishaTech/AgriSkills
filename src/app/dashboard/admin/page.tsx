        ...
        <div className="mb-10">
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              {/* Shorts Button */}
              <button
                onClick={() => router.push('/dashboard/admin/shorts')}
                className="bg-gradient-to-br from-red-500 to-red-600 text-white p-4 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 text-left group"
              >
                <div className="flex items-center justify-between">
                  <div>
                    <div className="bg-white/20 rounded-lg p-2 w-fit mb-2">
                    ...
                    <h3 className="font-semibold text-lg">Shorts</h3>
                    <p className="text-red-100 text-sm">Manage YouTube shorts</p>
                  </div>
                  <svg className="w-5 h-5 text-white/60 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <div className="relative">
                  <input
                    ...
                    className="bg-white border border-gray-300 text-gray-700 px-4 pr-10 py-2 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 w-full sm:w-auto touch-manipulation"
                  />
                  {searchQuery && (
                    <button
                      onClick={clearSearch}
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-md mx-4">
              ...
              <div className="flex justify-end space-x-4 mt-6">
                ...
                <button
                  ...
                  disabled={isSubmitting || !userForm.name.trim() || !userForm.email.trim() || !userForm.password.trim()}
